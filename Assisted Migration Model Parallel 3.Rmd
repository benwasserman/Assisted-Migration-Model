...
In 3rd edition I also decreased 
#Setup
...
#Now outside of either of the two loops (first sesh and second sesh, I'll pick the rescue)
  ...
  #2025_07_11 to test whether match should be to future or current, i am replacing in the line above this "LANDfuture = LANDsimfuture" with "LANDfuture = LANDsim" 
...
save(Paramdf, results_mclapply, file = paste0("Outputs/Parallel/", Paramdf$RunID[1], "_Outputs_3rd_Ed.Rdata"))
beep(sound = 6)
```
